...
export interface ApiFinanzaFinanza extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Fecha_valor: Attribute.Date;
    Tipologia: Attribute.Enumeration<['Gasto', 'Ingreso', 'Inversion']>;
    ...
    >;
    Subcategoria: Attribute.Enumeration<
      [
        'Farmacia',
        'Cuidado Personal',
        'Ropa',
...
export interface ApiGatoGato extends Schema.CollectionType {
  collectionName: 'gatos';
  info: {
    singularName: 'gato';
    pluralName: 'gatos';
    displayName: 'Gato';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::gato.gato', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::gato.gato', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Valor1: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Valor2: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Valor3: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Valor4: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Localizacion: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPublicacionPublicacion extends Schema.CollectionType {
  ...
  attributes: {
    Titulo: Attribute.String;
    Contenido_JSON: Attribute.Blocks;
    portada: Attribute.Media;
    Contenido_Markdown: Attribute.RichText;
    clave: Attribute.UID;
    featured: Attribute.Boolean;
    SuperFeatured: Attribute.Boolean;
