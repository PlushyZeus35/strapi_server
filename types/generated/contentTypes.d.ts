...
export interface ApiFinanzaFinanza extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Subcategoria: Schema.Attribute.Enumeration<
      [
        'Farmacia',
        'Cuidado Personal',
        'Ropa',
    ...
    >;
    Tipologia: Schema.Attribute.Enumeration<['Gasto', 'Ingreso', 'Inversion']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGatoGato extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::gato.gato'> &
      Schema.Attribute.Private;
    Nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Localizacion: Schema.Attribute.Text &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Valor1: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Valor2: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Valor3: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Valor4: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPublicacionPublicacion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    clave: Schema.Attribute.UID;
    Contenido_JSON: Schema.Attribute.Blocks;
    Contenido_Markdown: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    SuperFeatured: Schema.Attribute.Boolean;
    Titulo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
